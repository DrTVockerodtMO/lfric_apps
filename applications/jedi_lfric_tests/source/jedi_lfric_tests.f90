...
!> @brief Tests running the linear model in jedi_lfric_tests

!> @details Calls the linear model init, step and finalise routines to test
!>          running the linear model from jedi_lfric_tests. This file should be
!>          kept in sync with the linear model program file located at:
